...
public class DeepSeekServiceImpl implements DeepSeekService {
    ...
    public String generateDescription(String productTitle) {
        ...
        String userPrompt = "Generate a short product description for a product titled: \"" + productTitle + "\". Focus on key features and benefits if inferable.请用中文为我生成描述，不超过300字";
